...
function insert(el, parentContainer, anchor) {
...
export { compileToFunction, createApp, createElement, createVNode as createElementVNode, createRenderer, createTextVNode, effect, getCurrentInstance, h, inject, insert, isProxy, isReactive, isReadonly, isRef, nextTick, patchProp, provide, proxyRefs, reactive, readonly, ref, registerRuntimeCompiler, remove, renderSlots, setChildren, shallowReadonly, toDisplayString, unRef };
